...
const guidesData: Omit<HowToGuide, "searchText">[] = [
  ...
  },
  {
    ...
    audience: ["All Staff"],
    summary: "Managing automated alerts and tasks.",
    ...
    steps: [
      ...
      "Click the bell to view alerts for approvals, overdue tasks, RPN risks, and follow-ups.",
      "Alerts are intelligently deduplicated by the system to prevent spam.",
      "You can mark alerts as 'Read' to keep them, or 'Resolve' to clear them once the issue is handled.",
    ],
  },
  // ==========================================
