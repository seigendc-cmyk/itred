...
function isListLikeKey(key: string): boolean {
  return [
    ...
    "delivery_services",
    "itred_rpn_agents",
    "itred_rpn_field_operations",
    "itred_catalogue_deployments",
    "itred_leads_center",
    "itred_vendor_conversion_center",
    "orders",
    "itred_audit_logs",
    "pos_terminals",
    "pos_shifts",
